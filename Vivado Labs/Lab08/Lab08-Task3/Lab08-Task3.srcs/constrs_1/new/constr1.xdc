...
#set_property PACKAGE_PIN U1 [get_ports {switches[11]}]
#set_property PACKAGE_PIN T1 [get_ports {switches[12]}]
#set_property PACKAGE_PIN R2 [get_ports {switches[13]}]
#set_property PACKAGE_PIN R1 [get_ports {switches[14]}]
#set_property PACKAGE_PIN P2 [get_ports {switches[15]}]
