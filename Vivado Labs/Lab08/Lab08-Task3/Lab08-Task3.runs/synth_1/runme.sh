...
HD_PWD='C:/Users/ghazi/CA-LAB-SPR-2026/Vivado Labs/Lab08/Lab08-Task3/Lab08-Task3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log memoryFPGA_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source memoryFPGA_Top.tcl
