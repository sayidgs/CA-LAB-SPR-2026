...
HD_PWD='C:/Users/ghazi/CA-LAB-SPR-2026/Vivado Labs/Lab08/Lab08-Task3/Lab08-Task3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log memoryFPGA_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source memoryFPGA_Top.tcl -notrace
